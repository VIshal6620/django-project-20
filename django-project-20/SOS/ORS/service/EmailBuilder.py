class EmailBuilder:
    ...
    def sign_up(params):
        ...
        msg += "<H1>Hi! Greeting from sunilOS!<H1>"
        msg += "<p>Congratulations for Registration on ORS! You can now access your ORS account online - anywhere,anytime and enjoy the flexibility to check the Marksheet Details.</p> "
        msg += "<p>Log in today at <a href='http://ors.sunraystechnology.com'>http://ors.sunraystechnology.com</a>with your following credentials:<p/>"
